...
#else
extern GMenu * menu_style (glwin * view);
extern GMenu * menu_map (glwin * view);
extern GMenu * menu_render (glwin * view);
extern GMenu * menu_quality (glwin * view);
extern GMenu * menu_atoms ( glwin * view, int at);
extern GMenu * menu_bonds (glwin * view, int at);
...
extern GMenu * menu_rings (glwin * view);
extern GMenu * extract_section (glwin * view);
extern GMenu * menu_edit (glwin * view, int popm);
extern GMenu * menu_tools (glwin * view, int popm);
extern GMenu * menu_reset (glwin * view);
extern GMenu * menu_fullscreen (glwin * view);
extern GMenu * menu_rep (glwin * view);
extern GMenu * menu_proj (glwin * view);
extern GMenu * menu_back (glwin * view);
extern void menu_axis (GMenu * menu, glwin * view);
extern void menu_items_view (GMenu * menu, glwin * view, int popm);
extern GMenu * prepare_opengl_menu (glwin * view);
extern GMenu * prepare_model_menu (glwin * view);
extern GMenu * prepare_coord_menu (glwin * view);
extern GMenu * menu_view (glwin * view, int popm);
extern GMenu * menu_anim (glwin * view);
#endif
