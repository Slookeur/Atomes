...
/*!
* @file amber96.c
* @short Amber-96 force field, from 'parm96'
...
int amber96_objects[14] = {54, 2, 0, 83, 0, 0, 191, 0, 81, 0 , 0, 31, 35, 0};
int amber96_dim[14] = {4, 12, 0, 5, 0, 0, 6, 0, 9, 0, 0, 8, 4, 0};

/*
 Atoms
  0= Element, 1= Mass, 2= Key, 3= Description, 4= Amber_96 info
*/
char * amber96_atoms[54][4]= {{"Br", "79.90", "BR", "! bromine"},
...
*/
char * amber96_equi[2][12]= {{"N", "NA", "N2", "N*", "NC", "NB", " ", " ", " ", " ", " ", " "},
                             {"C", "C*", "CA", "CB", "CC", "CN", "CM", "CK", "CQ", "CW", "CV", "CR"}};

/*
 Quadratic bonds
  0= Key_a, 1= Key_b, 2= Kb (kcal mol^-1 A^2), 3= R0 (A), 4= amber96 info

  V(R) = Kb x (R - R0)^2
*/
char * amber96_bonds[83][5]= {{"OW", "HW", "553.0", "0.9572", "! TIP3P water"},
...
*/
char * amber96_angles[191][6]= {{"HW", "OW", "HW", "100.", "104.52", "TIP3P water"},
...
/*
 Dihedrals
  0-3= Keys, 4= Kchi (kcal mol^-1), 5= delta (deg), 6= n (multi), 7= amber96 info

  V(chi) = Kchi x (1 + cos (n x (chi) - delta))
*/
char * amber96_dihedrals[81][9]= {{"X", "C", "CA", "X", "4", "14.50", "180.0", "2.", "intrpol.bsd.on C6H6"},
                                  ...
                                  {"C", "N", "CT", "C", "1", "0.30", "180.0", "-2.", "Kollman et al. 1997"},
                                  {"C", "N", "CT", "C", "1", "0.85", "000.0", "1.", "Kollman et al. 1997"},
                                  {"N", "CT", "C", "N", "1", "0.30", "180.0", "-2.", "Kollman et al. 1997"},
                                  {"N", "CT", "C", "N", "1", "0.85", "000.0", "1.", "Kollman et al. 1997"},
...
/*
 Impropers
  0-3= Keys, 4= Kpsi (kcal mol^-1 rad^-2), 5= psi0 (deg), 6= n (multi), 7= amber96 info

  V(psi) = Kpsi x (psi - psi0)^2
*/
char * amber96_impropers[31][8]= {{"X", "X", "C", "O", "10.5", "180.", "2.", "JCC,7,(1986),230"},
...
/*
 Non-bonded
  0= Key, 1= epsilon (kcal mol^-1), 2= Rmin/2 (A), 3= amber96 info
...
*/
char * amber96_vdw[35][4]= {{"H", "0.6000", "0.0157", "!Ferguson base pair geom."},
